...
import { Mail, FolderOpen, Github, Linkedin, Twitter } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 md:mb-16 relative">
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
              <div className="w-24 h-24 md:w-36 md:h-36 rounded-full flex items-center justify-center flex-shrink-0 relative bg-[#FFC224] border-4 border-white">
                <Mail className="w-12 h-12 md:w-16 md:h-16 text-black" />
              </div>
              ...
              <div className="w-full flex-1 bg-white border-4 border-black rounded-3xl py-4 px-4 md:py-6 md:px-8 flex flex-col md:flex-row items-center gap-4 md:gap-6">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="bg-black text-white hover:bg-black/90 rounded-xl px-6 md:px-10 py-3 md:py-4 text-sm md:text-base font-semibold transition-colors"
                  >
                    Get in touch
                  </a>
                </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0">
                  <Image
                    src="https://apneajyhbpncbciasirk.supabase.co/storage/v1/object/public/nft-storage/PFP.jpg"
                    alt="Piyush Saini"
                    width={32}
                    height={32}
              ...
              <p className="text-gray-400 mb-6 text-sm leading-relaxed">
                Full-Stack Engineer specializing in Web2, AI SaaS, and Web3.
              ...
              <div className="flex gap-3">
                ...
                <a
                  href="https://www.linkedin.com/in/piyush-saini-b860ab1bb/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-[#2F81F7] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
                >
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>
              © 2025 Piyush Saini. Built with Next.js & TypeScript. All rights
              reserved.
            </p>
          </div>
        </div>
