    ...
    <div className="pt-12 pb-8 space-y-6">
      ...
      <div className="flex items-center gap-3">
        <a
          ...
          target="_blank"
          className="cta-glare group flex items-center gap-4 bg-[#1e293b] text-white px-6 py-4 rounded-full hover:bg-zinc-800 transition-all active:scale-95 shadow-lg shadow-zinc-200"
        >
        ...
        <a
          ...
          className="w-14 h-14 rounded-full border border-[#e2e8f0] flex items-center justify-center hover:bg-zinc-50 transition-colors"
        ...
        {/* <div className="w-auto bg-white border border-[#f1f5f9] rounded-3xl px-3 py-2  shadow-sm">
          <div className="text-center  items-center justify-center">
            <div className="text-base font-bold text-[#1e293b]">1.5+</div>
            <div className="text-[8px] font-bold text-[#94a3b8] uppercase tracking-wider">
              Years Exp
            </div>
          </div>
        </div> */}
