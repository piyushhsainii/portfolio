...
const ProfileHero: React.FC = () => {
  return (
    <div className="pt-12 pb-8 space-y-6">
      ...
      {/* Stats Card */}
      <div className="max-w-xs bg-white border border-[#f1f5f9] rounded-3xl p-8 py-5 grid grid-cols-2 gap-4 shadow-sm">
        <div className="text-center space-y-1">
          <div className="text-2xl font-bold text-[#1e293b]">1.5+</div>
