    ...
    return (
        <div className="h-screen w-screen overflow-y-auto " >
            ...
            <div className='  pt-0 h-[auto] px-5 font-bold Name-color  ' >
                <h2 className={`text-8xl `}> <span className='sr-only' >{name}</span>
                        <motion.span
                            initial="hidden"
            ...
            <div className='text-2xl my-4 font-bold px-5 p-3 flex text-color ' >
                <span> I Transform <span className='text-yellow-700' > Caffeine</span>  </span> <img src="/coffee-cup.png" width={22} className='mx-2' alt="" />  into {' <'}  <span className='text-green-500' ><Typewriter typeSpeed={60} words={[`Code`]} loop={false} /></span> {'/>'} <span className='text-green-500'><Cursor/></span>
            </div>
                ...
                <div className='w-[85%]  mt-10  m-auto border p-2 border-opacity-70 rounded-md border-slate-500 ' >
                    <div className='' >
                        <Tabs defaultValue="1" className="max-w-[500px] ">
                            ...
                            <TabsContent value="3">
                                <div className='border-slate-700 border bg-slate-800 bg-opacity-65 w-[90%] m-4 p-2' >
                                ...
                                <a href="FinalCV.pdf" download={false} >
                                  <img className='h-[500px] w-[350px] ' src="CV.png"  alt="" />
                                </a>
                            </div> */}
                                </div>
                            </TabsContent>
